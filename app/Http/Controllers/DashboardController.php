        ...
        if($role_id == 4){
            ...
            $recentSales = Revenue::select(
                    ...
                    $accountCounts = Account::where('accounts.user_id',$user_id)->select(
                            DB::raw('TO_CHAR(accounts.created_at, \'YYYY-MM\') as month'),
                        ...
                        ->groupBy(DB::raw('TO_CHAR(accounts.created_at, \'YYYY-MM\')'))
                        ->orderBy(DB::raw('TO_CHAR(accounts.created_at, \'YYYY-MM\')'), 'asc')
                        ->get();
