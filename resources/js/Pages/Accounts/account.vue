                ...
                <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                        <div v-for="item in accounts" :key="item.id" class="border-b p-2">
                            <div class="max-w-sm w-full lg:max-w-full lg:flex mb-2">
                                <div class="w-1/4 bg-white rounded-lg pr-4 sahdow-lg flex flex-col justify-center items-center">
                                ...
                                <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                    <div class="mb-8">
                                        <p class="text-gray-600 flex items-center">
                                            ...
                                            <span class="text-green-600 font-bold font-italic"> {{ item.project_stage_information[item.project_stage_information.length-1].project_stage_name }} </span>
                                        </p>
                                        <div class="text-sky-500 font-bold text-xl mb-2"><Link :href="route('dashboard')">{{ item.business_name }}</Link></div>
                                        <h4>CLIENT</h4>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="border p-4">
                                            <div class="text-gray-900 font-bold text-xl mb-2">Account Contact Person</div>
                                        ...
                                        <!-- <div class="border p-4">
                                            <div class="text-gray-900 font-bold text-xl mb-2">Client Main Contact Person</div>
                                            <div class="flex items-center">
                                                <img class="w-10 h-10 rounded-full mr-4" src="/usericon.png" alt="Avatar of Jonathan Reinink">
                                                <div class="">
                                                    <p class="text-black-900 font-bold pb-2 leading-none">{{ item.main_contact_person_name }}</p>
                                                    <p class="text-gray-900 pb-2 leading-none">{{ item.main_contact_person_email }}</p>
                                                    <p class="text-gray-900 pb-2 leading-none">{{ item.main_contact_person_phone }}</p>
                                                    <p class="text-gray-900 pb-2 leading-none">{{ item.main_contact_person_designation }}</p>
                                                </div>
                                            </div>
                                        </div> -->
                                    </div>
                            ...
                            <div class="p-2">
                                ...
                                <div class="max-w-sm w-full lg:max-w-full lg:flex mb-2">
                                <div class="w-1/4 bg-white rounded-lg pr-4 sahdow-lg flex flex-col justify-center items-center">
                                    <div class="text-gray-900 font-bold text-xl mb-2">Client Profile</div>

                                    <div>
                                        <img class="object-center object-cover h-auto w-full" :src="`//${item.clientwebsiteurl}` + '/wp-content/uploads/2021/07/Website-Logo.png'" alt="photo">
                                    </div>
                                    <div class="text-center py-8 sm:py-6">
                                        <p class="text-xl text-gray-700 font-bold mb-1">{{  item.clientname }}</p>
                                        <p class="text-gray-600 flex items-center">

                                            <span class="text-gray-900 font-bold mr-1">Type: </span>
                                            <span class="text-green-600 font-bold font-italic"> {{ item.clienttype }} </span>
                                        </p>
                                        <p class="text-base text-gray-400 font-small">{{ item.clientemail }}</p>
                                        <p class="text-base text-gray-400 font-normal">{{ item.clientphone }}</p>
                                        <p class="text-base text-gray-400 font-normal">{{ item.clientlocation }}</p>
                                        <p class="text-base text-gray-400 font-normal">{{ item.client }}</p>
                                        <p class="text-base text-sky-500 font-normal">{{ item.clientwebsiteurl }}</p>
                                ...
                                <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                    <div class="mb-8 mt-4">
                                        <div class="text-gray-900 font-bold text-xl mb-4 ">Account Stages Information</div>

                                        <div class="">
                                            <div class="grid grid-cols-2 gap-4">
                                                <div v-for="(pitem, index) in item.project_stage_information" :key="pitem.id" class="border p-4">
                                                    <div class="flex items-center">
                                                        <div class="w-10 h-10 rounded-full mr-4 font-bold font-italic">{{ index + 1 }}</div>
                                                        <div class="">
                                                            <p class="text-black-900 font-bold pb-2 leading-none">{{ pitem.project_stage_name }}</p>
                                                            <p class="text-gray-900 pb-2 leading-none">Due Date: <span class="text-green-500">{{ pitem.due_date }}</span></p>
                                                            <p class="text-gray-900 pb-2 leading-none">{{ pitem.stage_information }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
