                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Main Contact</th>
                                ...
                                <tr v-for="item in clients" :key="item.id" class="border-b">
                                    ...
                                    <td class="">{{ item.main_contact_person_name }} <br> {{ item.main_contact_person_phone }} {{ item.main_contact_person_email }} <br> {{ item.main_contact_person_designation }}</td>

                                    <td class="px-4 py-3">
                                        <Link :href="route('accounts.client', { id: item.id })">
