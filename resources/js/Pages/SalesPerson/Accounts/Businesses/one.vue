       ...
       <section class="px-4 mt-8 sm:px-8">
            <section class="bg-gray-50 p-3 sm:p-5">
                <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                        <div v-for="item in accounts" :key="item.id" class=" p-2">
                            <div class="max-w-sm w-full lg:max-w-full lg:flex mb-2">
                                ...
                                <div class=" bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class=" p-4">
                                            <div class="text-gray-900 font-bold text-xl mb-2">Account Contact Persons</div>
                                            <div v-for="it in JSON.parse(item.contact_information)" class="flex items-center">
                                                ...
                                                <div class="">
                                                    ...
                                                    <p class="text-gray-900 leading-none">{{ it.designation }}</p>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class=" p-4">
                                            <div class="text-gray-900 font-bold text-xl mb-2">Client Main Contact Persons</div>
                                            <div v-for="it in JSON.parse(item.mainclienccontactinformation)" class="flex items-center">
                                                <img class="w-10 h-10 rounded-full mr-4" src="/usericon.png" alt="Avatar of Jonathan Reinink">
                                                <div class="">
                                                    <!-- <p class="text-black-900 text-bold leading-none">{{ JSON.parse(item.contact_information) }}</p> -->
                                                    <p class="text-gray-900 leading-none">{{ it.name }}</p>
                            ...
                            <div class="p-2">
                                ...
                                <div class="max-w-sm w-full lg:max-w-full lg:flex mb-2">
                                <div class="w-1/4 bg-white rounded-lg pr-4 sahdow-lg flex flex-col justify-center items-center">
                                    <div class="text-gray-900 font-bold text-xl mb-2">Solution Description</div>


                                    <div class="text-center py-8 sm:py-6">
                                        <p class="text-xl text-gray-700 font-bold mb-1">{{  item.solution_name }}</p>
                                        <p class="text-gray-600 flex items-center">

                                            <span class="text-gray-900 font-bold mr-1">BS/Name: </span>
                                            <span class="text-green-600 font-bold font-italic"> {{ item.business_name }} </span>
                                        </p>
                                        <p class="text-gray-600 flex items-center"><span class="text-gray-900 font-bold mr-1">Solution Type:</span><span class="text-green-600 font-bold font-italic">  {{ item.solution_type_name }}</span></p>
                                        <p class="text-gray-600 flex items-center"><span class="text-gray-900 font-bold mr-1">Solution: </span><span class="text-green-600 font-bold font-italic"> {{ item.solution_name }} </span></p>
                                        <p class="text-gray-600 flex items-center"><span class="text-gray-900 font-bold mr-1">Solution Sub Type: </span> <span class="text-green-600 font-bold font-italic"> {{ item.solution_sub_type_name }} </span></p>
                                ...
                                <div class=" bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                    <div class="mb-8 mt-4">
                                        ...
                                        <div class="">
                                            <div class="grid grid-cols-2 gap-4">
                                                <div v-for="(pitem, index) in item.project_stage_information" :key="pitem.id" class=" p-4">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div v-for="(item, index) in pitem.stage_meta" :key="index" class="px-4 py-1">
