...
const exportToExcel = () => {
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "Tender-RFQ Clients");
  XLSX.writeFile(workbook, "tender_rfq.xlsx");
};
    ...
    <div class="space-y-4">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1">
        <div class="relative flex-1 max-w-md">
          ...
          <input type="text" v-model="filters.global" placeholder="Search Tenders & RFQ by name, solution, stage..."
              ...
              <tr v-if="filteredClients.length === 0">
                <td colspan="5" class="px-6 py-16 text-center">
                  <div class="max-w-xs mx-auto">
                    ...
                    <p class="text-gray-900 font-bold text-sm">No Tender or RFQ Accounts Found</p>
