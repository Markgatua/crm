<script setup>
    ...
    const saveDepartment = () => {
        form.post(route('solution.store'), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const editDepartment = (item) => {
        ...
        editItem.value = item;
        form.name=item.solution_name;
        form.solution_type_id=item.solution_type_id
    }

    const updateDepartment = () => {
        form.put(route('solution.update',{ solution: editItem.value }), {
            preserveScroll: true,
            onSuccess: () => {
                closeEditModal()
                form.reset()
    ...
    const destroy=(item)=>{
        if (!confirm('Are You sure your want to delete ' + item.solution_name)){
            return
        }
        router.delete(route('solution-type.destroy',{ solution: item }))
    }
    </script>
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Solution Type Name</th>
                                    ...
                                    <tbody>
                                    <tr v-for="item in solution" :key="item.id" class="border-b">
