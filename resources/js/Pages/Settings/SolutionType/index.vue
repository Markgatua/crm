<script setup>
    ...
    const saveDepartment = () => {
        form.post(route('solution-type.store'), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const editDepartment = (item) => {
        ...
        editItem.value = item;
        form.name=item.solution_type_name;
        form.description=item.description
    }

    const updateDepartment = () => {
        form.put(route('solution-type.update',{ solution_type: editItem.value }), {
            preserveScroll: true,
            onSuccess: () => {
                closeEditModal()
                form.reset()
    ...
    const destroy=(item)=>{
        ...
        router.delete(route('solution-type.destroy',{ solution_type: item }))
    }
    </script>
                        ...
                        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tbody>
                                    <tr v-for="item in solutionType" :key="item.id" class="border-b">
