<script setup>
    ...
    const editDepartment = (item) => {
        ...
        editItem.value = item;
        form.name=item.document;
    }

    const updateDepartment = () => {
        form.put(route('document-type.update',{ document_type: editItem.value }), {
            preserveScroll: true,
            onSuccess: () => {
                closeEditModal()
                form.reset()
    ...
    const destroy=(item)=>{
        ...
        router.delete(route('document-type.destroy',{ document_type: item }))
    }
    </script>


    <template>
        <AppLayout title="Document Types">
           <PageHeader title="Document Types" name="document types" />
                        ...
                        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tr>
                                        <th scope="col" class="px-4 py-3">Document Types</th>
                                    ...
                                    <tbody>
                                    <tr v-for="item in documentType" :key="item.id" class="border-b">
