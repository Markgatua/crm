<script setup>
    ...
    const updateDepartment = () => {
        form.put(route('industries.update',{ industry: editItem.value }), {
            preserveScroll: true,
            onSuccess: () => {
                closeEditModal()
                form.reset()
    ...
    const destroy=(item)=>{
        ...
        router.delete(route('industries.destroy',{ industry: item }))
    }
    </script>


    <template>
        <AppLayout title="Industries">
           <PageHeader title="Industries" name="industries" />
                        ...
                        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tr>
                                        <th scope="col" class="px-4 py-3">Industries/Sectors</th>
                                    ...
                                    <tbody>
                                    <tr v-for="item in industries" :key="item.id" class="border-b">
